...
HOST="Wimpy"
LOCAL_CONFIG="$HOME/wimpy-setup/llama-hugs-config.yaml"
REMOTE_CONFIG="/home/rahlquist/wimpy-setup/llama-hugs-config.yaml"
...
printf '[3/4] Waiting for llama-hugs to reload...\n'
sleep 3
