...
echo "║  4. Add model paths to /etc/llama-hugs/config.yaml           ║"
echo "║     then: sudo systemctl enable --now llama-hugs             ║"
